...
public class MyBag {
	...
	//ProductsVM(String name, int place, int amount, int price)
	public MyBag() {
		//DrinksVM(String container,boolean carbohydrate)
		space[0]=new DrinksVM("Cola",0,0,15,"A sweetened, carbonated soft drink flavored with vanilla, cinnamon, citrus oils and other flavorings.",
								"33cl-Can",true);
